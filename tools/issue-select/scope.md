...
I have experience with Python, Git, GitHub, Docker, and working with
existing codebases. I am comfortable making focused code changes,
writing and running tests, and using GitHub issues and pull requests.
I am interested in backend development and improving my experience
with APIs, testing, and repository tooling. I prefer a clearly
bounded issue with understandable requirements rather than a large
